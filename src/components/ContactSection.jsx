...
const DribbbleIcon = () => (
  <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M12 24C5.385 24 0 18.615 0 12S5.385 0 12 0s12 5.385 12 12-5.385 12-12 12zm10.12-10.358c-.35-.11-3.17-.953-6.384-.438 1.34 3.684 1.887 6.684 1.992 7.308 2.3-1.555 3.932-4.02 4.392-6.87zM12 22.02c-.06 0-.12-.002-.18-.003-1.082-.01-5.185-.14-7.538-4.17 2.957-.83 6.31-1.076 7.82.016.326.236.63.5.908.788-.583 2.502-1 3.37-1.01 3.37zm-5.75-2.067c2.327 3.197 5.253 2.768 6.084 2.525-.664-.997-1.066-2.022-1.32-2.912-.19-.655-.343-1.286-.46-1.87-2.673-1.823-5.83-2.028-6.61-2.05-.008.267-.015.534-.015.803 0 1.25.29 2.43.805 3.486.27-.47.88-1.577 1.516-2.096.223.18.463.344.717.493z"/></svg>
)
...
function ContactCard({ card }) {
  ...
  return (
    <div className="group relative flex flex-col gap-3 rounded-xl border border-[#2A303C] bg-[#151921] p-5 transition-all duration-300 hover:border-white/30 hover:shadow-lg">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          {card.href ? (
            <a href={card.href} className="text-base font-medium text-white hover:text-gray-300 transition-colors font-mono">
              {card.value}
            </a>
          ) : (
...
function SocialCard({ social }) {
  return (
    <a
      href="#"
      className="group flex items-center gap-3 rounded-lg border border-[#2A303C] bg-[#151921] p-4 transition-all hover:bg-white/5 hover:border-white/30"
    >
  ...
  return (
    <section id="contact" className="flex flex-col gap-12">
      ...
      <div className="flex flex-col items-center text-center gap-4">
        ...
        {/* Headline */}
        <h3 className="text-4xl md:text-5xl font-extrabold tracking-tight text-white pb-1">
          Let's Connect
        </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* Location card */}
          <div className="mt-auto relative rounded-xl overflow-hidden h-40 bg-[#151921] border border-[#2A303C] flex items-center justify-center p-6 text-center">
            <div
